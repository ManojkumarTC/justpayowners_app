...
const PropertyRentDetails = ({ tabItems, setSideNavTabs, isSale, fetchAdvartise }) => {
        ...
        if (params.tabtitle == "property") { // to get fresh data from server when tab is clicked
            fetchAdvartiseData(params.guid, userId).then((data) => {
                ...
                if (data != null && data.data != null) {
                    setRentDetails(JSON.parse(data?.data?.propertyData).property_details);
                }
            });
        }
    ...
    const onSubmit = handleSubmit(async (data, e) => {
        ...
        formData.propertyData = JSON.stringify({ "property_details": rentDetails });
                                ...
                                <div className="col-12">
                                    ...
                                    <div className="selectgroup w-100">
                                        <label className="selectgroup-item">
                                            <input type="radio" name="NonVegAllowed" value="Yes" className="selectgroup-input" id='NonVegAllowed' onChange={e => optionchanged(e, 'NonVegAllowed')} checked={rentDetails.NonVegAllowed == "Yes"} />
                                            <span className="selectgroup-button">Yes</span>
                                        </label>
                                        <label className="selectgroup-item">
                                            <input type="radio" name="NonVegAllowed" value="No" className="selectgroup-input" id='NonVegAllowed' onChange={e => optionchanged(e, 'NonVegAllowed')} checked={rentDetails.NonVegAllowed == "No"} />
                        ...
                        <div className="form-group">
                            ...
                            <div className="row gutters-xs">
                                <div className="col-12">
                                    <div className="selectgroup w-100">
                                        <label className="selectgroup-item">
                                            <input type="radio" name="GatedSecurity" value="Yes" className="selectgroup-input" id='GatedSecurity' onChange={e => optionchanged(e, "GatedSecurity")} checked={rentDetails.GatedSecurity == "Yes"} />
                                            <span className="selectgroup-button">Yes</span>
                                        </label>
                                        <label className="selectgroup-item">
                                            <input type="radio" name="GatedSecurity" value="No" className="selectgroup-input" id='GatedSecurity' onChange={e => optionchanged(e, "GatedSecurity")} checked={rentDetails.GatedSecurity == "No"} />
                                            <span className="selectgroup-button">No</span>
                                        </label>
