                ...
                <>
                    ...
                    <div className="widget-content">
                        ...
                        <div className="location-area">
                            ...
                            {JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.landmark ? JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.landmark + ", " : ""}
                            {JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.street ? JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.street + ", " : ""}
                            {JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.locality ? JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.locality + ", " : ""}
                            {JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.city ? JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.city + ", " : ""}
                            {JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.state ? JSON.parse(advertiseData[0].propertyObject)?.LocalityDetails?.state + ", " : ""}
