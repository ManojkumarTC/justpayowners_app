...
const PropertyBanner = ({ property }) => {    
                ...
                <div className="featured-thumb-slider-area wow fadeInUp team-box1" data-wow-delay=".4s" id="swiper-container">
                    ...
                    <div className="feature-box3 swiper-container">
                        <div className="swiper-wrapper">
                            ...
                            >
                                {
                                    JSON.parse(property.propertyObject)?.GalleryDetails.map((listing, index) => (
            ...
            <div className="feature-box3 swiper-container">
                <div className="swiper-wrapper">
                    <div className="swiper-slide">
                        <div className="feature-img1 zoom-image-hover">
                            <img
                                src="/src/assets/img/blog/product1-1.jpg"
                                alt="feature"
                                width="798"
                                height="420"
                            />
                        ...
                        <div className="row gutters-5 team-box1" >
                            <div className="col-lg-6">
                                <div className="single-listing-box2">
                                    <div className="item-img">
                                        {renderPropertyLogo(property, 658, 460 ,1)}
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="row gutters-5">
                                    <div className="col-lg-6">
                                        <div className="single-listing-box3">
                                            <div className="item-img">
                                                {renderPropertyLogo(property, 600, 425 ,2)}
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                        <div className="single-listing-box3">
                                            <div className="item-img">
                                                {renderPropertyLogo(property, 600, 425 ,3)}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="single-listing-box4">
                                            <div className="item-img">
                                                {renderPropertyLogo(property, 605, 55 ,4)}
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    const renderPropertyLogo = (item, width, height) => {
        ...
        return <a onClick={getOnClick(JSON.parse(item.propertyObject)?.GalleryDetails != undefined ? JSON.parse(item.propertyObject)?.GalleryDetails[0] + "?auto=compress & cs= tinysrgb& w=1200" : "")}  href={JSON.parse(item.propertyObject)?.GalleryDetails != undefined ? JSON.parse(item.propertyObject)?.GalleryDetails[0] + "?auto=compress & cs= tinysrgb& w=1200" : ""}
           >
