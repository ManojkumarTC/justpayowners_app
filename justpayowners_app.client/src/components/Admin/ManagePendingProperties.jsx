...
const ManagePendingProperties = () => {
    ...
    const columns = [
        ...
        {
            name: 'Location',
            selector: row => JSON.parse(row.propertyData).LocalityDetails?.city,
            sortable: true,
        },
        {
            name: 'Action',
    ...
    const handlePublish = async (row) => {
        ...
        const propertyDetails = JSON.parse(row.propertyData);
        ...
        propertyModal.propertyObject = row.propertyData;
    ...
    return (
        <div className='w-100'>
            <div className='page-header'>
                <h1 className='text-2xl font-semibold'>Manage Pending Properties</h1>
            </div>
