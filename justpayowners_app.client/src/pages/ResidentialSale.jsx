...
import { PropertyPostingTabs, SectionTitle, PropertySubmitButton, PropertySubHeader, PropertyDetails, PropertyLocalityDetails, PropertyAmenitiesDetails, PropertyGalleryUpload, PropertyAdditionalInformation, PropertyScheduleDetails, PropertyResaleDetails } from '../components'
...
function ResidentialSale(props) {
                            ...
                            <div className="col-md-12 rtcl-login-form-wrap">
                                ...
                                <div id="residential-rent" className="my-1 my-md-1">
                                        ...
                                        <div className="col-12">
                                            <SectionTitle title="Residential Sale" path="" isfilterEnable={false} />
                                        </div>
                                        ...
                                        <div className="card">
                                            <div className="row g-0">
                                                <Tab.Container id="left-tabs-example" defaultActiveKey="vertical-tab-property-details" activeKey={activeTab}>
                                                    <Row className='m-0'>
                                                        <PropertyPostingTabs tabs={sideNavTabs} id={"tab-section-left"} isSale={true} isCommercial={false} />
                                                        <div id="tab-section-right" className="col-12 col-md-10 d-flex flex-column">
                                                            <Tab.Content>
                                                                <Tab.Pane eventKey="vertical-tab-property-details">
                                                                    ...
                                                                    <PropertyDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-locality-details">
                                                                    <PropertySubHeader Tilte="Locality Details" />
                                                                    <PropertyLocalityDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-resale-details">
                                                                    <PropertySubHeader Tilte="Resale Details" />
                                                                    <PropertyResaleDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-amenities">
                                                                    <PropertySubHeader Tilte="Amenities" />
                                                                    <PropertyAmenitiesDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-gallery">
                                                                    <PropertySubHeader Tilte="Gallery" />
                                                                    <PropertyGalleryUpload tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-additional-info">
                                                                    <PropertySubHeader Tilte="Additional Information" />
                                                                    <PropertyAdditionalInformation tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} islandorPlot={false}
                                                                        isResidential={true} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-schedule-info">
                                                                    <PropertySubHeader Tilte="Schedule" />
                                                                    <PropertyScheduleDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} />
                                                                </Tab.Pane>
                                                            </Tab.Content>
