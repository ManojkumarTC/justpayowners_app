...
import { PropertyPostingTabs, SectionTitle, PropertySubmitButton, PropertySubHeader, PropertyLandDetails, PropertyLocalityDetails, PropertyAmenitiesDetails, PropertyGalleryUpload, PropertyAdditionalInformation, PropertyScheduleDetails, PropertyResaleDetails } from '../components'
...
function LandorPlotSale(props) {
    const items = [
        ...
        {
            Title: "Schedule Information", eventKey: "vertical-tab-schedule-info", isDisabled: false, urlPath: "schedule", justpayFr: "pyp_schedule"
        }
    ];
    ...
    useEffect(() => {
        ...
        const propertyData = JSON.parse(advertiseData.data.propertyData);
                            ...
                            <div className="col-md-12 rtcl-login-form-wrap">
                                ...
                                <div id="residential-rent" className="my-1 my-md-1">
                                        ...
                                        <div className="col-12">
                                            <SectionTitle title="Plot Your Property for Free" path="" isfilterEnable={false} />
                                        </div>
                                        {/*   <!-- Page body -->*/}
                                        <div className="card">
                                            <div className="row g-0">
                                                <Tab.Container id="left-tabs-example" defaultActiveKey="vertical-tab-property-details" activeKey={activeTab}>
                                                    <Row className='m-0'>
                                                        <PropertyPostingTabs tabs={sideNavTabs} id={"tab-section-left"} isSale={true} isCommercial={false} islandorPlot={true} />
                                                        <div id="tab-section-right" className="col-12 col-md-10 d-flex flex-column">
                                                            <Tab.Content>
                                                                <Tab.Pane eventKey="vertical-tab-property-details">
                                                                    ...
                                                                    <PropertyLandDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} islandorPlot={true} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-locality-details">
                                                                    <PropertySubHeader Tilte="Locality Details" />
                                                                    <PropertyLocalityDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} islandorPlot={true} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-resale-details">
                                                                    <PropertySubHeader Tilte="Resale Details" />
                                                                    <PropertyResaleDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} islandorPlot={true} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-amenities">
                                                                    <PropertySubHeader Tilte="Amenities" />
                                                                    <PropertyAmenitiesDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} islandorPlot={true} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-gallery">
                                                                    <PropertySubHeader Tilte="Gallery" />
                                                                    <PropertyGalleryUpload tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} islandorPlot={true} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-additional-info">
                                                                    <PropertySubHeader Tilte="Additional Information" />
                                                                    <PropertyAdditionalInformation tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} islandorPlot={true}
                                                                        isResidential={false} />
                                                                </Tab.Pane>
                                                                <Tab.Pane eventKey="vertical-tab-schedule-info">
                                                                    <PropertySubHeader Tilte="Schedule" />
                                                                    <PropertyScheduleDetails tabItems={sideNavTabs} setSideNavTabs={setSideNavTabs} isSale={true} isCommercial={false} islandorPlot={true} />
                                                                </Tab.Pane>
                                                            </Tab.Content>
                                                        </div>
                                                    </Row>
