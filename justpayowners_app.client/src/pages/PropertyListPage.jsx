                        ...
                        <div className="col-lg-4 widget-break-lg sidebar-widget">
                            ...
                            <div className="widget widget-listing-box1">
                                ...
                                <div className="item-img">
                                    <a href="#"><img src="/src/assets/img/blog/widget6.jpg" alt="widget" width="630" height="400" /></a>
                            ...
                            <div className="widget widget-post">
                                <div className="item-img">
                                    <img src="/src/assets/img/blog/widget5.jpg" alt="widget" width="690" height="850" />
