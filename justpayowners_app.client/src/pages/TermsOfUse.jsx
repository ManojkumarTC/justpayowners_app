                        ...
                        <div className="page-content-block">
                                ...
                                <div className="col-md-12 rtcl-login-form-wrap">
                                    ...
                                    <div className="row flex-row-reverse flex-lg-row">
                                            ...
                                            <div className="about-box1 wow fadeInUp" data-wow-delay=".2s" style={{ visibility: 'visible', animationDelay: '0.2s', animationName: 'fadeInUp' }}>
                                        <span className="item-subtitle">Last Updated on 29 May, 2023</span>
